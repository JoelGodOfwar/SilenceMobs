...
import com.github.joelgodofwar.sm.common.error.BasicErrorReporter;
import com.github.joelgodofwar.sm.common.error.ErrorReporter;
...
public class PluginLibrary {
	...
	public static final ReportType REPORT_CANNOT_DELETE_CONFIG = new ReportType("Cannot delete old SilenceMobs configuration.");
	public static final ReportType REPORT_CANNOT_COPY_FILE = new ReportType("Cannot copy file.");

	public static final ReportType REPORT_PLUGIN_LOAD_ERROR = new ReportType("Cannot load SilenceMobs.");
	...
	public static final ReportType REPORT_PLUGIN_ENABLE_ERROR = new ReportType("Cannot enable SilenceMobs.");
