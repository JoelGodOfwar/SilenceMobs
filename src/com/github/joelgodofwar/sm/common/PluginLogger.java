...
/**
 * Custom logger for the SilenceMobs plugin.
 */
public class PluginLogger {
	 ...
	 * @param plugin The SilenceMobs plugin instance.
	 */
	public PluginLogger(SilenceMobs plugin) {
	...
	public void log(Level level, String message, Object... args) {
		String pluginName = ChatColor.RESET + "[" + ChatColor.YELLOW + SM.getName() + ChatColor.RESET + "] ";
