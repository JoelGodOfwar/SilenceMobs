...
public class VersionChecker {
	...
	public VersionChecker(SilenceMobs plugin, int projectID, String githubURL) {
		this.sm = plugin;
	...
	public boolean checkForUpdates() throws Exception {
		...
		sm.LOGGER.debug("currentVersion=" + currentVersion);
		sm.LOGGER.debug("releaseVersion=" + releaseVersion);
		sm.LOGGER.debug("developerVersion=" + developerVersion);
