package com.github.joelgodofwar.sm.util.heads;

import com.github.joelgodofwar.sm.util.datatypes.JsonDataType;
...
public class HeadUtils {
	 ...
	 */
	private static URL convertBase64ToURL(String base64) throws Exception {
		try {
