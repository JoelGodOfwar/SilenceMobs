package com.github.joelgodofwar.sm.api;
...
public class UpdateChecker {
    ...
    public UpdateChecker(JavaPlugin plugin, int projectID) {
        ...
        try {
            checkURL = new URL("https://github.com/JoelGodOfwar/SilenceMobs/raw/master/versioncheck/" + newVersion.substring(0, 4) + "/version.txt");
